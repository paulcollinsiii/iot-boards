...
TEST_CASE(
    "**CRON_JOB - cron_job_list_init() return 0 if module is not initialized",
    "[cron_job_list]") {
  cron_job_list_dinit();
...
TEST_CASE(
    "**CRON_JOB - cron_job_has_loaded() return -1 if module is already "
    "initialized",
    "[cron_job_list]") {
  cron_job_list_dinit();
...
TEST_CASE("**CRON_JOB - cron_job_list_insert() return -1 if job is NULL",
          "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
...
TEST_CASE(
    "**CRON_JOB - cron_job_list_insert() return the new node id if the node is "
    "added to list",
    "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
...
TEST_CASE(
    "**CRON_JOB - cron_job_list_insert() return the new node id if the node is "
    "added to list while inserting 2 nodes",
    "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
  cron_job *job = test_create_job("test1", 8);
...
TEST_CASE("**CRON_JOB - cron_job_list_insert() add two nodes width the same id",
          "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
  cron_job *job = test_create_job("test1", 1);
...
TEST_CASE("**CRON_JOB - cron_job_list_remove() return 0 if the node exist",
          "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
...
TEST_CASE("**CRON_JOB - cron_job_list_remove() return -5 if the node exist",
          "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
  cron_job *job = test_create_job("test", -1);
...
TEST_CASE(
    "**CRON_JOB - cron_job_list_remove() return 0 when remove the last element",
    "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
  cron_job *job = test_create_job("test", 1);
...
TEST_CASE(
    "**CRON_JOB - cron_job_list_remove() return 0 when remove the first "
    "element",
    "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
...
TEST_CASE("**CRON_JOB - cron_job_node_count() return 0 if there is no nodes",
          "[cron_job_list]") {
  cron_job_list_dinit();
...
TEST_CASE("**CRON_JOB - cron_job_node_count() return 2 if there is two nodes",
          "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
  cron_job *job = test_create_job("test", 1);
...
TEST_CASE("**CRON_JOB - cron_job_node_count() return 5 if there is five nodes",
          "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
  cron_job *job = test_create_job("test", 1);
...
TEST_CASE(
    "**CRON_JOB - cron_job_node_count() return 3 if there is five nodes but "
    "removes 2",
    "[cron_job_list]") {
  cron_job_list_dinit();
  (void)cron_job_list_init();
